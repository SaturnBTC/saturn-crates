...
use saturn_bitcoin_transactions::utxo_info::{FixedOptionUtxoInfo, SingleRuneSet, UtxoInfo};
...
fn create_test_utxo(value: u64, txid_byte: u8, vout: u32) -> UtxoInfo<SingleRuneSet> {
